...
Se [Användningsfall](use-cases.md) för den funktionella beskrivningen av flödet och [REST-interaktioner och sökparametrar](rest-interactions.md) för den tekniska realiseringen.

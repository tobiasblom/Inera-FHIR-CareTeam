...
Landningssidan ger en översikt av krav på system som vill ansluta sig till Ineras tjänster via FHIR.
...
Se även [Nedladdningar](downloads.md) och [Versionshistorik](version-history.md).

# Resource Inera FHIR Implementation Guide Template
...
```json
{
  ...
  "status" : "draft",
  "date" : "2026-09-01T12:56:52+00:00",
  "publisher" : "Inera AB",
  "contact" : [{
    "name" : "Inera AB",
    "telecom" : [{
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://fhir.inera.se/ig/template/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    },
    {
      ...
      "exampleCanonical" : "https://fhir.inera.se/ig/template/StructureDefinition/IneraPatient"
    }],
    "page" : {
      "extension" : [{

...
2. Konsumenten skickar en förfrågan till producentens FHIR-API.
3. Producenten söker fram de fasta kontakter som motsvarar förfrågan.
4. Producenten returnerar informationen representerad enligt profilerna i denna IG.
5. Konsumenten tolkar informationen och använder den i sitt aktuella sammanhang.
...
Se [REST-interaktioner och sökparametrar](rest-interactions.html) för den tekniska realiseringen av förfrågan och [Förväntade svar](expected-responses.html) för hur olika svarssituationer hanteras.
